...
{
    public class WorldContextSeddData
    {
        private WordContext _context;
        private UserManager<WorldUser> _userManager;

        public WorldContextSeddData(WordContext context, UserManager<Models.WorldUser> userManager)
        {
            _context = context;
        ...
        public async Task EnsureData()
        {
            ...
            if(await _userManager.FindByEmailAsync("ph@gmail.com") == null)
            {
                var user = new Models.WorldUser() { UserName = "PH", Email = "ph@gmail.com" };
